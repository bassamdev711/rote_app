...
class _CollectionTabState extends ConsumerState<CollectionTab> {
  ...
  String? get _effectiveWorkDayId =>
      widget.workDayId ?? ref.read(currentWorkDayProvider).value?.id;
  ...
  Future<void> _loadData() async {
    ...
    final data = await ref
        ...
        .getCollectionsByCustomer(widget.customer.id!, workDayId: wdId);
    if (mounted)
      setState(() {
        _collections = data;
        _loading = false;
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Text(
                                      '${c.amount.toStringAsFixed(2)} ريال',
                                      style: const TextStyle(
                                        color: AppTheme.success,
                                        fontWeight: FontWeight.bold,
                                      ),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: isSaving
                        ...
                        : () async {
                            final amount =
                                AppUtils.tryParseDouble(amountCtrl.text) ?? 0;
                            if (amount <= 0) {
                              _showErrorDialog(
                                ctx,
