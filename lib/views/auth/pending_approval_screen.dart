...
class PendingApprovalScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('بانتظار الموافقة'),
        centerTitle: true,
        actions: [
          IconButton(
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton.icon(
                ...
                label: const Text('تواصل مع المطور (واتساب)', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                style: ElevatedButton.styleFrom(
                  backgroundColor: Colors.green,
                  padding: const EdgeInsets.symmetric(horizontal: 24, vertical: 12),
                ),
                onPressed: () async {
                  final url = Uri.parse('whatsapp://send?phone=+967780500363&text=${Uri.encodeComponent("السلام عليكم، لقد سجلت في التطبيق وهذا رقمي الذي سجلت به: ")}');
